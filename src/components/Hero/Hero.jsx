...
function Hero() {
  return (
    <section className="bg-slate-950 h-[700px] flex" id="hero">
      <div className="container mx-auto flex flex-col justify-center sm:items-center items-start px-5 text-white gap-4">
        ...
        <div className="">
          <button className="p-3 border-2 border-blue-500 rounded-md hover:bg-blue-500">
            <a href="#contact" className="sm:text-xl text-lg">
              Contact Me
            </a>
          </button>
        </div>
